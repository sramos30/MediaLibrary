...
CREATE TABLE IF NOT EXISTS file_metadata (
	...
	source_disk VARCHAR(50) DEFAULT NULL,
	...
	full_hash VARCHAR(64) CHARACTER SET ascii COLLATE ascii_bin DEFAULT NULL,
	partial_blocks INT DEFAULT NULL,
	needs_full_hash BOOLEAN DEFAULT TRUE,
